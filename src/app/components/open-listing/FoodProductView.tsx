...
const top: CSSProperties = {
  background: 'linear-gradient(135deg, #FF9A1F 0%, #FF7A00 45%, #EA580C 100%)',
...
export default function FoodProductView({ listing }: { listing: ListingModel }) {
  const {
    id,
    title,
    location,
    ...
    <main style={page}>
      ...
      <section style={body}>
          ...
          <div style={card}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{ fontSize: 13, color: 'var(--text-3)' }}>Restaurant on Vero360</p>
              </div>
            </div>
            {shopId ? (
              <Link
        ...
        <div style={card}>
          <a
            href={appHref}
            style={{ ...btn, background: '#EA580C', color: '#fff', marginTop: 0 }}
          >
            Order in Vero360 app
          </a>
          <a
          ...
          >
            Have Vero360? This dish opens in the app. If you don&apos;t, you can view it here.
          </p>
        </div>
      </section>
    </main>
